...
class CeleryResultModelTest(TestCase):
    ...
    def test_celery_result_creation(self):
        ...
        self.assertEqual(self.celery_result.arguments, [123, "test", {"arg1": 123, "arg2": "abc"}])
    ...
    def test_auto_created_fields(self):
        ...
        self.assertGreaterEqual(self.celery_result.updated_at, self.celery_result.created_at)
