...
class ApartmentDetails(BaseModel):
    ...
    form_of_the_property = models.CharField(verbose_name=_("Form Of The Property"), max_length=64, blank=True, null=True)
    finishing_condition = models.CharField(verbose_name=_("Finishing Condition"), max_length=64, blank=True, null=True)
    ...
    market = models.CharField(verbose_name=_("Market"), max_length=64, blank=True, null=True)
