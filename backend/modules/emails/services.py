...
class EmailService:
    ...
    def _send_email_to(self, receiver: str | Sequence[str], subject: str, body: str) -> bool:
        message = create_message(self.LOGIN, receiver, subject, body)
        return send_email(message, self.LOGIN, self.PASSWORD, receiver)

    def send_offers(
        self, receiver: str | Sequence[str], offers: list[tuple[Apartment, ApartmentDetails]]
    ) -> bool:
